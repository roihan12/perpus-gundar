...
<?php if($this->session->flashdata('pesan') == "Ditambah"): ?>
    <div class="alert alert-success" role="='alert">
        Data Buku Telah Berhasil Ditambah!
    </div>
    ...
    <div class="alert alert-success" role="='alert">
        Data Buku Telah Berhasil dihapus!
    </div>
    <?php endif ?>
...
<td> 
<a href="<?= base_url('buku/ubahBuku/').$b['id'];?>" class="btn btn-lg badge badge-info"><i class="fas fa-edit"></i> Ubah</a> 
